...
public class Dateien : List<Datei>
{
    ...
    public Dateien(Aliasse aliasse, List<string> referenzmerkmale)
    {
        ...
        this.Add(new Datei(aliasse, referenzmerkmale, @"ImportFürSchild\SchuelerBasisdaten.dat",        // Dateipfad
...
//        this.Add(new Datei(aliasse, referenzmerkmale,
...
//new string[] { "MarksPerLesson", "Student_" },      // andere benötigte Dateien. Die erste Datei bestimmt die Anzahl der Zeilen der herauskommenden Datei
//"SchuelerTeilleistungen"));                     // Funktionsname (Case-Sensitive)


//        this.Add(new Datei(aliasse, referenzmerkmale,
//@"ImportFürSchild\SchuelerTelefonnummern.dat",                                                                                                        // Dateipfad
//datbeschreibung,                                                                                                                            // Hinweise zum Download
//new List<string> { "Nachname", "Vorname", "Geburtsdatum", "Telefonnr.", "Art" },
//"SchuelerTelefonnummern.dat erzeugen",// Titel der Datei; wird im Menü angezeigt
//@"Beschreibung: Enthält zusätzliche Telefonnummern der Schüler bzw. der Erzieher.",                 // Beschreibung
//new string[] { "AlleAdressen", "Student_" },      // andere benötigte Dateien. Die erste Datei bestimmt die Anzahl der Zeilen der herauskommenden Datei
//"SchuelerTeilleistungen"));                     // Funktionsname (Case-Sensitive)

        
//        this.Add(new Datei(aliasse, referenzmerkmale,
//@"ImportFürSchild\SchuelerLeistungsdaten.dat",                                                                                                        // Dateipfad
//datbeschreibung,                                                                                                                            // Hinweise zum Download
...
//"SchuelerLeistungsdaten.dat erzeugen",// Titel der Datei; wird im Menü angezeigt
//@"Beschreibung: Enthält die Leistungsdaten (Fächer und Noten) eines Lernabschnittes (=Halbjahr oder Quartal) der Schüler.",                 // Beschreibung
//new string[] { "MarksPerLesson", "ExportLessons", "StudentgroupStudents", "AbsencePerStudent_", "Student_" },      // andere benötigte Dateien. Die erste Datei bestimmt die Anzahl der Zeilen der herauskommenden Datei
//"SchuelerTeilleistungen"));                     // Funktionsname (Case-Sensitive)

//        this.Add(new Datei(aliasse, referenzmerkmale,
//@"ExportAusWebuntis\ExportLessons",                                                                                                        // Dateipfad
//datbeschreibung,                                                                                                                            // Hinweise zum Download
//new List<string> { "lessonId", "lessonNumber", "subject","teacher","klassen","studentgroup","periods","startDate","endDate","room","foreignKey" },
//"...",// Titel der Datei; wird im Menü angezeigt
//@"...",                 // Beschreibung
//new string[] { "MarksPerLesson" },      // andere benötigte Dateien. Die erste Datei bestimmt die Anzahl der Zeilen der herauskommenden Datei
//"SchuelerTeilleistungen"));                     // Funktionsname (Case-Sensitive)


//        this.Add(new Datei(aliasse, referenzmerkmale,
//@"ExportAusWebuntis\StudentgroupStudents_",                                                                                                        // Dateipfad
//datbeschreibung,                                                                                                                            // Hinweise zum Download
//new List<string> { "studentId","name","forename","studentgroup.name","subject","startDate","endDate" },
//"....",// Titel der Datei; wird im Menü angezeigt
//@"....",                 // Beschreibung
//new string[] { "MarksPerLesson" },      // andere benötigte Dateien. Die erste Datei bestimmt die Anzahl der Zeilen der herauskommenden Datei
//"SchuelerTeilleistungen"));                     // Funktionsname (Case-Sensitive)
...
//        this.Add(new Datei(aliasse, referenzmerkmale,
//@"ExportAusWebuntis\AbsencePerStudent_",  // Dateipfad
//new string[] { "Beschreibung." },                                // Hinweise zum Download
//new List<string> { "Quelldatei", "Zieldatei" }, // Kopfzeile
//"Titel",          // Titel der Datei; wird im Menü angezeigt
//@"Beschreibung: ...",                 // Beschreibung
//new string[] { },      // andere benötigte Dateien. Die erste Datei bestimmt die Anzahl der Zeilen der herauskommenden Datei
//"SchuelerTeilleistungen"));                     // Funktionsname (Case-Sensitive)
